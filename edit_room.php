...
var id_sector=$("#de").attr("value");var check_status_1='room';var check_status_2='edit';var id_room=<? echo"$_POST[id_room_]"; ?>;
...
ชื่อห้อง :<input type="text" id="ae" value="<? echo $room_sel_temp; ?>" > 
</td></tr>
<tr><td>
...
?><option value="<? echo $id_building_temp; ?>" <? if($id_building_temp==$id_building_sel_temp){echo "selected";} ?> ><? echo $building_temp; ?></option><?
$j++; }
?></select>
...
?><option value="<? echo $id_sector_temp; ?>" <? if($id_sector_temp==$id_sector_sel_temp){echo "selected";} ?>  ><? echo $sector_temp; ?></option><?
$i++;
}?></select>
</td>
<td>
