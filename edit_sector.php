...
$(function(){$("#btt").click(function(){var id_sector=<? echo $_POST['id_sector_']; ?>;var sector_name=$("#sector_name").attr("value");
...
ชื่อหน่วยงาน :<input type="text" id="sector_name" value="<? echo $fetch_sector['sector'];?>" ><p>
...
?><option <? if($id_building_temp_bu==$fetch_sector['id_building']){echo "selected";} ?> value="<? echo $id_building_temp_bu; ?>"><? echo $building_temp_bu; ?></option><?
$bu++;
}?></select>
...
?><option <? if($id_belong_temp_be==$fetch_sector['id_belong']){echo "selected";} ?>  value="<? echo $id_belong_temp_be; ?>"><? echo $belong_temp_be; ?></option><?
$se++;
}?></select>
