...
if($_SESSION['user_status_session']=='9'){
$result = $mysqli->query("SELECT * FROM list_service WHERE job_status='อยู่ในระหว่างการดำเนินการ' AND id_technician_a='$_SESSION[username_session]' ORDER BY id_list DESC limit $start,$pagesize");
}
