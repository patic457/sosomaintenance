...
$(function(){$("#btt").click(function(){var id_building_=<? echo $_POST['id_building_']; ?>;var building=$("#building_edit").attr("value");var floorr=$("#floor_edit").attr("value");var check_status_1='building';var check_status_2='edit';
...
ชื่ออาคาร : <input type="text" id="building_edit" name="building_edit"  value="<? echo $fetch['building']; ?>">
</td><td>
ชั้นทั้งหมด : <input name="floor_edit" id="floor_edit" type="text" maxlength="2" value="<? echo $fetch['floor']; ?>" >
