...
$(function(){$("#btt").click(function(){var id_problem=<? echo $_POST['id_problem_']; ?>;var problem_name=$("#problem_name").attr("value");var check_status_1='problem';var check_status_2='edit';
...
ชื่อประเภทของปัญหา :<input type="text" id="problem_name" value="<? echo $fetch['problem'];?>" >&nbsp;<input type="button" id="btt" value="ส่งข้อมูล"   >
</form>
</td>
</tr>
</table>
