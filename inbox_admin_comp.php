...
if($_SESSION['user_status_session']=="0"){
$result = $mysqli->query("SELECT * FROM list_service WHERE username='$_SESSION[username_session]' ORDER BY id_list DESC limit $start,$pagesize");}
else if($_SESSION['user_status_session']=="1" || $_SESSION['user_status_session']=="2"){
$result = $mysqli->query("SELECT * FROM list_service ORDER BY id_list DESC limit $start,$pagesize");}
...
echo"</td><td><a href=\"index.php?m=4.1&&id_list=$id_list_temp\" title='แสดงรายละเอียด'><img src='images/view.png' alt='แสดงรายละเอียด' width='16' height='16' border='0' /></a></td></tr>";
$i++;
}
