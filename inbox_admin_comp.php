...
$sql_page = mysql_query("SELECT count(date) as date FROM list_service");}
...
if($_SESSION['user_status_session']=="0"){
$result = mysql_query("SELECT * FROM list_service WHERE username='$_SESSION[username_session]' ORDER BY id_list DESC limit $start,$pagesize");}
else if($_SESSION['user_status_session']=="1" || $_SESSION['user_status_session']=="2"){
$result = mysql_query("SELECT * FROM list_service ORDER BY id_list DESC limit $start,$pagesize");}
