...
<p>
<div id="edit-div"></div>
<div class='title'>รายชื่ออาคาร</div>
<p>
				...
				$(function() {
					$("#btd<?php echo $i; ?>").click(function() {
						if (confirm('คุณต้องการลบข้อมูลนี้ ?') == true) {
							var check_status_1 = 'building';
							var check_status_2 = 'del';
							var id_building_ = "<?php echo $id_building_temp; ?>";
							$.post("check_admin.php", {
									check_status_1: check_status_1,
									check_status_2: check_status_2,
									id_building_: id_building_
								},
								function(data) {
									$("#del-div").html(data);
