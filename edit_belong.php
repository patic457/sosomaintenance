...
$(function(){$("#btt").click(function(){var id_belong_=<? echo $_POST['id_belong_']; ?>;var belong_=$("#belong_edit").attr("value");var check_status_1='belong';var check_status_2='edit';
...
ชื่อสังกัด :<input type="text" name="belong_edit" id="belong_edit" value="<? echo $fetch['belong']; ?>" ></td><td>
