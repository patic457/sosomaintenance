...
ชื่อผู้ใช้ : <input id="usernamee" type="text" maxlength="10" onKeyUp="isEngNumchar(this.value,this)" onKeyUp="isSignchar(this.value,this)" value="<?php echo $fetch_sel['username']; ?>" disabled ></td>
